...
const dictionaries = {
  th: {
    ...
    'nav.menu': 'เมนู',
    'nav.pos': 'ขายสินค้า',
    'nav.posCounter': 'ขายหน้าร้าน',
    'nav.posWeight': 'ชั่งกิโล',
    'nav.posQuickProduct': 'เพิ่มสินค้าเร็ว',
    'nav.posDebt': 'สมุดลูกหนี้',
    'nav.expandPos': 'เปิดเมนูขายสินค้า',
    'nav.collapsePos': 'ปิดเมนูขายสินค้า',
    ...
    'pos.mode.saleTitle': 'ขายหน้าร้าน',
    'pos.mode.saleSubtitle': 'สแกน ค้นหา หรือแตะสินค้าขายด่วน',
    'pos.mode.weightTitle': 'ชั่งกิโล',
    'pos.mode.weightSubtitle': 'ขายสินค้าตามน้ำหนักแล้วส่งเข้าตะกร้า',
    'pos.mode.quickProductTitle': 'เพิ่มสินค้าเร็ว',
    'pos.mode.quickProductSubtitle': 'สร้างสินค้าเฉพาะหน้าแล้วขายต่อได้ทันที',
    'pos.mode.debtTitle': 'สมุดลูกหนี้',
    'pos.mode.debtSubtitle': 'บันทึกขายเชื่อและรับชำระของลูกค้า',
  ...
  en: {
    ...
    'nav.posCounter': 'Counter Sale',
    'nav.posWeight': 'Weighted Sale',
    'nav.posQuickProduct': 'Quick Product',
    'nav.posDebt': 'Debt Ledger',
    'nav.expandPos': 'Expand sales menu',
    'nav.collapsePos': 'Collapse sales menu',
    ...
    'pos.mode.saleTitle': 'Counter Sale',
    'pos.mode.saleSubtitle': 'Scan, search, or tap a quick-sale item',
    'pos.mode.weightTitle': 'Weighted Sale',
    'pos.mode.weightSubtitle': 'Sell by weight and send items to the cart',
    'pos.mode.quickProductTitle': 'Quick Product',
    'pos.mode.quickProductSubtitle': 'Create an item on the spot and sell it immediately',
    'pos.mode.debtTitle': 'Debt Ledger',
    'pos.mode.debtSubtitle': 'Record credit sales and customer payments',
